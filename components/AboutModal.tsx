            ...
            >
                <div className={`bg-white dark:bg-zinc-900 rounded-lg shadow-xl w-full max-w-md transform transition-all duration-300 ${isOpen ? 'scale-100' : 'scale-95'}`}>
                    <div className="p-5 border-b border-gray-200 dark:border-zinc-800 flex justify-between items-center">
                        <h2 id="about-modal-title" className="text-xl font-bold text-gray-800 dark:text-zinc-200">About This App</h2>
                    ...
                    <div className="p-6 space-y-4 text-gray-600 dark:text-zinc-300">
                        <div className="flex justify-between">
                            <span className="font-semibold text-gray-700 dark:text-zinc-200">Developed & Created by:</span>
                            <span>Suhail Zubair</span>
                        </div>
                         <div className="flex justify-between">
                            <span className="font-semibold text-gray-700 dark:text-zinc-200">Version:</span>
                            <span>1.0.0</span>
                        </div>
                         <div className="text-center pt-2">
                            <p className="font-semibold text-gray-700 dark:text-zinc-200 mb-1">Purpose</p>
                        ...
                        <div className="pt-2 border-t border-gray-200 dark:border-zinc-800 space-y-2">
                             <div className="flex justify-between items-center">
                                <span className="font-semibold text-gray-700 dark:text-zinc-200">Email:</span>
                             ...
                             <div className="flex justify-between items-center">
                                <span className="font-semibold text-gray-700 dark:text-zinc-200">Website:</span>
